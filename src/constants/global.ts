export const experiences = [
  {
    workPeriode: "OCT 2022 - PRESENT",
    title: "Frontend Engineer · eFishery",
    description: [
  ...
  {
    workPeriode: "OCT 2020 - JUNE 2023",
    title:
  ...
  },
  {
    ...
    title: "Frontend Engineer · Virtual Spirit",
    description: [
  ...
  {
    workPeriode: "OCT 2018 - APR 2019",
    title: "Frontend Engineer · Komers",
    description: [
...
export const projects = [
  ...
  {
    name: "Fish Internal Tool, eFishery",
    description:
  ...
  {
    name: "Circles.MD, Virtual Spirit",
    description:
  ...
  {
    name: "PropSocial, Virtual Spirit",
    description:
  ...
  {
    name: "Virtualspace, Virtual Spirit",
    description:
  ...
  {
    name: "Komers App, Komers",
    description:
      "Develop & Design from scratch mobile e-commerce apps that focus on selling textile components like cloth, thread, etc.",
    technologies: ["JavaScript", "React Native", "CSS", "Redux Saga"],
  },
];

export const segments = ["ABOUT", "EXPERIENCES", "PROJECTS"];
